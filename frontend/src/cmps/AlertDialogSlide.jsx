    ...
    <div className='alert-dialog-slide'>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={props.onRemoveRecipe}>Agree</Button>
        </DialogActions>
      </Dialog>
    </div>
  );
